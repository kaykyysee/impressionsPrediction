...
if hasattr(vectorizer, 'idf_'):
    print("Vectorizer telah ditraining.")
    ...
    print(vocabulary_df.head(10))  # Tampilkan 10 kata pertama
else:
    print("Vectorizer belum ditraining. Tidak ada atribut `idf_`.")
    print("Isi vocabulary:", vectorizer.vocabulary_)
